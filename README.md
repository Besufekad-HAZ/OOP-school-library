...
```sh
  cd my-folder
  git clone git@github.com:Besufekad-HAZ/OOP-school-library.git (SSH)
```
...
Feel free to check the [issues page](https://github.com/Besufekad-HAZ/OOP-school-library/issues).
